    ...
    <div class="row">
        <div class="card">
            <div class="row no-gutters">
                <!-- Image Column -->
                <div class="col-md-4">
                    <img src="../public/assets/img/shop/<?php echo $shop->image; ?>" class="card-img" alt="<?php echo $shop->image; ?>">
                </div>
                <!-- Information Column -->
                <div class="col-md-8">
                    <div class="card-body">
        ...
        foreach ($listProduct as $product): ?>
                                    <ul class="list-group" style="height: 200px; width: auto; ">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <img src="../public/assets/img/food/<?php echo $product->image; ?>" alt="<?php echo $product->image; ?>" width="100" class="flex-shrink-0">
                                            ...
                                            <a href="<?php echo ($user == null) ? 'login.php' : "product_page.php?shop_id={$shop->shop_id}&id_product={$product->id}"; ?>" class="btn btn-warning btn-add-to-cart">Thêm vào giỏ hàng</a>
                                        </li>
                                    </ul>
                    <?php endforeach;
    } ?>
